...
const DeleteUserModal = ({ showModal, onClose }: { showModal: Boolean, onClose: any }) => {
            ...
            <div className="modal px-10 py-4 bg-white rounded-sm drop-shadow w-full md:w-1/2 lg:w-[30vw]">
                <div className="modal-content">
                    ...
                    <div className="modal-footer flex py-2 gap-2  justify-between">
                        ...
                        <button type="button" className="btn bg-backG text-white py-2 px-4 lg:px-10 lg:py-3 btn-secondary" data-dismiss="modal" onClick={handleSubmit}>Restrict User</button>
                    </div>
                </div>
            </div>
        </div>
