  ...
  <div className="bg-white border-2 h-5/6  rounded-lg border-[#0000002] overflow-auto">
        <div className="flex px-5 place-items-center justify-between gap-6 py-5">
          <div className="flex gap-10">
            <h1 className="pt-3 font-bold text-[1.1em]">Doctors</h1>
            <div className="px-2 ">
              <select
                name=""
                id=""
                className="bg-white border-2 border-[#00000020]  rounded-2xl outline-none px-2 py-2"
              >
          ...
          <div className="md:flex hidden justify-end gap-4">
            <div>
              <input
                ...
                value={searchtext}
                className="form-control rounded-lg outline-none border-none text-backG py-4 px-20 bg-inputG"
          ...
          <table className=" table-auto w-full  ">
            <thead>
              <tr>
                ...
                <th className="py-5 text-[#000000c8] text-sm ">
                  Appointment Date
                </th>
                <th className="py-5 text-[#000000c8] text-sm ">
              ...
              {ScheduleData ? (
                ScheduleData.map((schedule: any) => (
                  <tr
                    ...
                    className="bg-inputG  hover:cursor-pointer  hover:bg-white duration-300 hover:drop-shadow-lg border-4 border-white py-4"
                  >
