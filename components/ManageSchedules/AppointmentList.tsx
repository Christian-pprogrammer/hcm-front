    ...
    <div className="px-2 bg-[#F7F7F7]">
        ...
        <div className="bg-white border-2 h-[85vh]  rounded-lg border-[#0000002]">
            <div className="flex px-5 place-items-center justify-between gap-6 py-5">
                <span aria-hidden="true" className='text-backG' onClick={handleBackPage}>&times;</span>
                ...
                <div className="md:flex hidden justify-end gap-4">
                    ...
                    <div className='flex gap-2'>
                        <button disabled={showAction ? false : true} onClick={()=>setMapModal(true)} className='py-4 bg-linear border-backG border-2 text-backG flex place-items-center justify-center px-4  rounded-lg'>
