    ...
    return (
        <div className="min-h-screen  bg-white px-8 lg:px-[8em]">
            <div className="flex justify-center place-items-center ">
                ...
                <ArrowSvg/><span>Live Reviews</span>
                </div>
            ...
            <div className="flex py-10 justify-between gap-6">
                <div className='h-[70vh]  hidden md:flex relative w-[30vw] rounded-full bg-backG'>
                    <Image src="/static/femaledoctor.png" width="600" height="600" alt="" className='absolute w-full rounded-full h-full bottom-0 left-0 right-0' />
                </div>
