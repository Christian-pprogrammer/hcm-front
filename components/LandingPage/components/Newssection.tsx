...
const Newssection = () => {
    return (
        <div className="min-h-[60vh]  flex place-items-center bg-white  py-10 px-8 lg:px-[8em]">
            <div className='bg-backG py-20 px-20 lg:p-20 text-center gap-8 text-white min-h-[50vh] lg:min-w-[50vw] flex flex-col'>
                ...
                <form action="" className='w-full flex  '>
                    <input type="text" className="w-full outline-blue-500 outline-3 text-backG p-5 px-20 bg-white" placeholder="Subscribe to Our newsLetter" />
