        ...
        <div className="bg-white border-2 h-[85vh] w-full rounded-lg border-[#0000002]">
            <div className="flex px-5 place-items-center justify-between gap-6 py-10">
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <div>
                        <button onClick={toggleAddAccount} className='py-4 bg-backG text-white flex place-items-center justify-center px-10 rounded-lg  gap-6'>
                            <FaPlus/>
                            <span>Add Account</span>
                            <AddAccount addAccount={addAccount} onClose={toggleAddAccount} />
                        </button>
                    </div>
                </div>
            </div>
