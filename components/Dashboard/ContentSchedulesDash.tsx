...
import ScheduleManagerTable from './ScheduleManagerTable'
import Chart from './Chart'
import ConfirmAppManager from './ConfirmAppManager'


const ContentSchedulesDash = () => {
    return (
        <div className="px-2 py-4">
            ...
            <div className="flex gap-2">
                <div className="chart-data min-w-[55vw] max-h-[85vh] bg-white rounded-lg p-5 border-2 border-[#0000003]">
                    ...
                    <h1 className='font-bold '>Schedules Services</h1>
                    <div className="px-2">
...
export default ContentSchedulesDash