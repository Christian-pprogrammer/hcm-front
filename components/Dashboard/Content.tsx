            ...
            <div className="flex  gap-2">
                <div className="chart-data min-w-[55vw] max-h-[85vh] bg-white rounded-lg p-5 border-2 border-[#0000003]">
                    ...
                    <div className='flex gap-8 py-5'>
                        <div className='flex hover:cursor-pointer duration-300 group hover:bg-backG hover:text-white hover:scale-110 h-[15vh] lg:w-60 p-5 rounded-lg flex-col relative  bg-inputG'>
