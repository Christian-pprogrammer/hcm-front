...
import AddNewDoctor from './Modals/AddNewDoctor'
import ManageUsersFetch from './tables/manage-doctors-fetch'
import { IUser } from '../../utils/ModalTypes'
import { system_users } from '../../utils/constants'

const ManageDoctorAdmin = () => {
                ...
                <div className="flex px-5 place-items-center justify-between gap-6 py-5">
                    ...
                    <div className="md:flex hidden justify-end gap-4">
                        ...
                        <div>
                            ...
                            <AddNewDoctor showModal={AddUserModal} onClose={() => setAddUserModal(false)} />
                        </div>
                    </div>
                </div>
...
export default ManageDoctorAdmin;
