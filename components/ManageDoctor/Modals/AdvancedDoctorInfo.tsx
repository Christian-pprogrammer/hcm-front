...
const AdvancedDoctorInfo = ({ FormData, setFormData }: { FormData: IUser, setFormData: React.Dispatch<React.SetStateAction<IUser>> }) => {
    ...
    const handleOnServiceSelect = (selectedServices: SelectedData[]) => {
        ...
        setFormData({ ...FormData, services: serviceIds });
    }
...
export default AdvancedDoctorInfo
